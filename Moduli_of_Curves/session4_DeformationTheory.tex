...
%        以下の図式を考える．
%        \[\vcenter{\xymatrix{
%            {} & {} & f^*\shE \ar[d]_-{\bar{f}}\ar[r]^-{\bar{\kappa}}& \shF' \ar[d]^-{f}& {} \\
%            0 \ar[r]& \shG \ar[r]_-{\iota}& \shE \ar[r]_-{\kappa}& \shF \ar[r]\centerpb& 0
%        }}\]
%        この時，$\bar{\kappa}$ :: surjかつ$\ker \bar{\kappa} \iso \shG$．
%    \end{Claim}
%    \begin{proof}
%        (TODO: epi$\implies$epiは出来ない．
%        $\bar{\kappa}$ :: surjと，任意の$\shX \to \shF'$が$\bar{\kappa}$を通して分解することが
%        同値であることを示し，利用するしかなさそう．
%        $\ker \bar{\kappa} \iso \shG$は$\shG$が$\ker \bar{\kappa}$の普遍性を持つことを示せば良い．)
%    \end{proof}
